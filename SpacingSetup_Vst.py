...
class Ui_LocationSetup(object):
	def setupUi(self, LocationSetup):
		...
		self.ssCaliperMap_graphicsView = MatplotlibWidget(LocationSetup)
		...
		self.ssCentralizerLocations_tableWidget = QtGui.QTableWidget(LocationSetup)
		...
		self.ssAccept_pushButton = QtGui.QPushButton(LocationSetup)
		...
		self.ssNextSpacing_tableWidget = QtGui.QTableWidget(LocationSetup)
	...
	def retranslateUi(self, LocationSetup):
		LocationSetup.setWindowTitle(_translate("LocationSetup", "Centralizers Spacing Setup", None))
		...
		item.setText(_translate("LocationSetup", "SO at\\nmidspan", None))
		self.ssAccept_pushButton.setText(_translate("LocationSetup", "Accept", None))
		...
		item.setText(_translate("LocationSetup", "Next stage spacing           ", None))
