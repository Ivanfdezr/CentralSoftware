...
class Ui_CentralizerDatabase(object):
	def setupUi(self, CentralizerDatabase):
		...
		self.CDBRigid_tableWidget = QtGui.QTableWidget(self.tab_2)
		self.CDBRigid_tableWidget.setGeometry(QtCore.QRect(2, 3, 810, 425))
		self.CDBRigid_tableWidget.setHorizontalScrollMode(QtGui.QAbstractItemView.ScrollPerPixel)
		self.CDBRigid_tableWidget.setRowCount(200)
		self.CDBRigid_tableWidget.setColumnCount(14)
		self.CDBRigid_tableWidget.setObjectName(_fromUtf8("CDBRigid_tableWidget"))
		...
		self.CDB_tabWidget.setCurrentIndex(0)
	...
	def retranslateUi(self, CentralizerDatabase):
		...
		self.CDB_tabWidget.setTabText(self.CDB_tabWidget.indexOf(self.tab_2), _translate("CentralizerDatabase", "Rigid", None))
