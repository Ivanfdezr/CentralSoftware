...
class Ui_LocationSetup(object):
	def setupUi(self, LocationSetup):
		...
		self.lsSideForces_graphicsView.setObjectName(_fromUtf8("lsSideForces_graphicsView"))
	...
	def retranslateUi(self, LocationSetup):
		...
		item.setText(_translate("LocationSetup", "Stage", None))
		self.lsAccept_pushButton.setText(_translate("LocationSetup", "DONE", None))
		self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("LocationSetup", "Side Forces", None))
